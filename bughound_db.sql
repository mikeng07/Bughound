...
CREATE TABLE version_areas (                                            -- bridge table b/t 'release_versions' and 'areas'
    version_area_id     INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    version_id          INT NOT NULL,
    area_id             INT NOT NULL,
    FOREIGN KEY (version_id) REFERENCES release_versions (version_id),  -- connects to release_versions:version_id
...
CREATE TABLE reports (
    ...
    FOREIGN KEY (release_id) REFERENCES program_releases (release_id),
    FOREIGN KEY (version_id) REFERENCES release_versions (version_id),
